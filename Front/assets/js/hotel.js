    ...
    const sectionHTML = `
        <div class="d-flex" style="min-width: auto; max-width: 275px; margin: 12px;">
            <div class="d-flex justify-content-center align-items-end" data-bss-hover-animate="pulse">
                ...
                <button class="btn btn-primary" type="button" data-bs-target="#modal-hotel-detail${hotel.id}${type}" data-bs-toggle="modal" style="border-radius: 0px; border-style: none; position: absolute; background: rgba(11,24,43,0); width: 275px; height: 275px; display: block;"></button>
    ...
    const modalHTML = `
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Start: Hotel picture -->
                <div class="carousel slide" data-bs-ride="false" id="carousel-${hotel.id}${type}">
                    <div id="carrouselimg${hotel.id}${type}" class="carousel-inner">  
                    </div>
                    <div>
                        <!-- Start: Previous --><a class="carousel-control-prev" href="#carousel-${hotel.id}${type}" role="button"
                            data-bs-slide="prev"><span class="carousel-control-prev-icon"></span><span
                                class="visually-hidden">Previous</span></a><!-- End: Previous -->
                        <!-- Start: Next --><a class="carousel-control-next" href="#carousel-${hotel.id}${type}" role="button"
                            data-bs-slide="next"><span class="carousel-control-next-icon"></span><span
                                class="visually-hidden">Next</span></a><!-- End: Next -->
                    </div>
                    <div class="carousel-indicators" id="carousel-indicators${hotel.id}${type}">
                        </div>
            ...
            <div class="modal-footer d-lg-flex justify-content-lg-center">
                <form class="d-flex justify-content-center flex-wrap justify-content-lg-center align-items-lg-center" id="bookingForm${hotel.id}${type}">
                    ...
                    <div style="margin-right: 12px; margin-left: 12px; margin-top: 6px; margin-bottom: 12px;">
                        ...
                        <div class="d-flex">
                            <input class="form-control" type="date" id="dateFrom${hotel.id}${type}"
                            ...
                            <input class="form-control" type="date" id="dateTo${hotel.id}${type}"
                    ...
                    <div class="d-flex d-lg-flex flex-column justify-content-lg-start" style="margin-right: 8px;">
                        ...
                        <input class="form-control form-control-sm" type="number" id="numberOfRooms${hotel.id}${type}"
                               style="width: 64px; height: 32px;" name="number_room" value="1" min="1" required>
                    </div>
                    <!-- End: Input Room -->
                
                    <!-- Start: Button Validate -->
                    <button class="btn btn-primary btn-lg" type="button" id="bookHotelButton${hotel.id}${type}"
